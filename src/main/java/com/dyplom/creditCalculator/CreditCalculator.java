...
public class CreditCalculator {
    ...
    void calculate(BigDecimal sum, float percentage, int countOfMonth){
        ...
        /*System.out.println("основой платеж = " + creditBody);

        System.out.println("----------------------------------------------------------------------------------");

        System.out.println("Месяц         Остаток кредита               Основной Платеж             Проценты             Всего за платеж");*/
        ...
        for (int i = 0; i < countOfMonth; i++) {
            ...
            payments.add(p);
            /*System.out.println(" "+i +"    "+"     "+ loanBalance +  " руб.            "    +
                    creditBody + " руб.              " +   payOPercent   + " руб.         "                + " " + payForMonth + " руб.");*/
        }
        ...
        /*System.out.println("Сумма платежей = " + allPays);
        System.out.println("Выплаты за проценты = " + payForPercent);*/
    }
}
